...
int main(int argc, char **argv)
{
    ...
    // 创建源矩阵、目标矩阵，初始化矩阵数据
    tensor_new_2d(src1Mat, m, k, sizeof(vint8m1_t), src1Data);  // src1data初始化src1Mat矩阵
    tensor_new_2d(src2Mat, k, n, sizeof(vint8m1_t), src2Data);
    tensor_new_2d(dstMat, m, n, sizeof(vint8m1_t), &dstData);
