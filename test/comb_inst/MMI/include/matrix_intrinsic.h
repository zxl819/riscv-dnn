...
// SET DTYPE=FP64 SEW=64
#define SET_MBA0_FP64() CONFIGURATION_MTYPE(0x10, 0x3)

// SET DTYPE=FP16,F32 SEW=16
#define SET_MBA0_FP16_FP32() CONFIGURATION_MTYPE(0x5, 0x1)
// SET DTYPE=FP32,FP64 SEW=32
#define SET_MBA0_FP32_FP64() CONFIGURATION_MTYPE(0x14, 0x2)

// SET DTYPE=FP16,FP32 SEW=32
#define SET_MBA0_FP32_FP16() CONFIGURATION_MTYPE(0x5, 0x2)
// SET DTYPE=FP32,FP64 SEW=64
#define SET_MBA0_FP64_FP32() CONFIGURATION_MTYPE(0x14, 0x3)
